...
class HMM(object):
    ...
    def test(self, word_lists, word2id, tag2id, omask):
        pred_tag_lists = []
        for word_list in word_lists:
            pred_tag_list = self.decoding(word_list, word2id, tag2id, omask)
            pred_tag_lists.append(pred_tag_list)
        return pred_tag_lists

    def decoding(self, word_list, word2id, tag2id, omask=0.5):
        """
    ...
    def get_entities(self, text, word2id, tag2id, omask):
        entities = []
        output = self.test([text], word2id, tag2id, omask)[0]
        word,tag = '','O'
